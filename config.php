...
/** عنوان الموقع **/
$page_name = "تهنئة بمناسبة عيد الأضحي المبارك"; 
...
/***    رابط الموقع    ***/
$sharing_url = "https://ayoubmq2002.github.io/Eid-Mubarak/";

/***    رسالة التهنئة     ***/
$sharing_message = $name." يهنئك بإقتراب حلول عيد الأضحي المبارك "; 
...
/***    رسالة التهنئة     ***/
$sharing_name = "تهنئة شخصية بحلول عيد الأضحي المبارك"; 
...
$aid_to = "بمناسبة عيد الأضحي المبارك";

/***   محتوى التهنئة    ***/
$aid_text = "يا عالي المقام اهنئك قبل الزحام بعيد الأضحي المبارك .. عسى ربي يحفظك طول الزمان، ويرزقك التقوى والإيمان وقصور هدية من الرحمن في أعلى الجنان وكل عام وأنت بخير يا أعز إنسان";
...
$aid_timer = "July 19, 2021 00:00:00";

/***   رسالة العد العكسي   ***/
$aid_time = "تبقى على عيد الأضحي";

/***   رسالة حلول العيد    ***/
$aid_said = "لقد حل عيد الأضحي المبارك";
